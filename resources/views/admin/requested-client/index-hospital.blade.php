        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="confirm-btn">
                    ...
                    <a href="{!! route('admin.requested-client.confirmed.index',['type' => 'hospital']) !!}" class="btn btn-primary ml-5">Confirmed</a>
                </div>
...
@section('scripts')
<script>
var hospitalIndex = "{!! route('admin.requested-client.all.hospital.table') !!}";
...
<script src="{!! asset('js/pages/requested-client/hospital.js') !!}"></script>
