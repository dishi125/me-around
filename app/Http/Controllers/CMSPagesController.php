...
class CMSPagesController extends Controller
{
    ...
    public function getJsonData(Request $request)
    {
        ...
        $cmsQuery = CMSPages::whereNull('type')->select('*');
    ...
    public function pageSlugName($pageName) {
        ...
        if(!CMSPages::whereNull('type')->whereSlug("$pageName")->exists()){
            return $pageName;
        }

        $i = 1;
        while(CMSPages::whereNull('type')->whereSlug("$pageName-$i")->exists()) $i++;
        return "$pageName-$i";
    }
    ...
    {
        $pageData = CMSPages::whereNull('type')->where('slug',$slug)->first();
        return view("pages.view",compact('pageData'));
    }

    public function supportPageSpa(){
        return view("spa.pages.support");
    }
}
