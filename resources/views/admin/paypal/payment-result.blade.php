...
$pay_rst = (isset($response['PCD_PAY_RST'])) ? $response['PCD_PAY_RST'] : "";
...
$pay_type = (isset($response['PCD_PAY_TYPE'])) ? $response['PCD_PAY_TYPE'] : "";
$pay_goods = (isset($response['PCD_PAY_GOODS'])) ? $response['PCD_PAY_GOODS'] : "";
$payer_name = (isset($response['PCD_PAYER_NAME'])) ? $response['PCD_PAYER_NAME'] : "";
$pay_total = (isset($response['PCD_PAY_TOTAL'])) ? $response['PCD_PAY_TOTAL'] : "";
$pay_msg = (isset($response['PCD_PAY_MSG'])) ? $response['PCD_PAY_MSG'] : "";
$pay_time = (isset($response['PCD_PAY_TIME'])) ? $response['PCD_PAY_TIME'] : "";
...
<link href="{{ asset('css/paypal_style.css') }}" rel="stylesheet" />
<div class="device__layout">
    <div class="line_setter has_bg">
        <div class="demo_result">
            <div class="tit__demo_result">
                <div class="logo"><img src="{{ asset('image/logo_full_white.svg') }}" alt="" class="res"></div>
                <div class="date"> <?php echo $pay_date; ?> </div>
            </div>
            <div class="smr__demo_result">
                <div class="icon"><img src="{{ asset('image/icon-card.svg') }}" alt="" class="res"></div>
            ...
            <div class="ctn__demo_result">
                <div class="detail-block-outer">
                    ...
                    <div class="detail-block">
                        ...
                        <div class="block-value"> <?php echo $bill->pay_goods; ?> </div>
                    </div>
                    <div class="detail-block">
                ...
                <div class="total-block dp_flex flc_jc_sb flc_al_center has_spacer_y_16">
                    ...
                    <div class="block-value"><span class="total-amount"><?php echo $bill->pay_total; ?></span>원 </div>
                </div>
            </div>
        </div>
