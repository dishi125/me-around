...
return [
    ...
    */
    ...
    'user' => [
        ...
        'social_id.required' => 'This social id is required.',
        'social_type.required' => 'This social type is required.',
        ...
        'phone_max' => 'Only 10 users can use this mobile number. Please try with another number',
        'phone_max_month' => 'An account with this mobile number is created recently. Please try after 30 days',
        'tag.required' => 'Please complete the hashtag'
    ],
    'user-1' => [
        'email.required' => 'The email is required.',
        'email.string' => 'The email is invalid.',
        'email.max' => 'The email is too long.',
        'email.unique' => '이미 존재하는 이메일ID 입니다',
        'email.exists' => 'This email does not exist.',
        'social_id.required' => 'This social id is required.',
        'social_type.required' => 'This social type is required.',
        'password.required' => 'The password is required.',
        ...
        'name.string' => 'The Username is invalid.',
        'name.alpha' => '사용자명은 텍스트만 사용가능합니다',
        'device_id.required' => 'The device id required.',
        'device_type.required' => 'The device type is required.',
        'phone.required' => 'The Phone is required',
        'phone.numeric' => 'The Phone is invalid',
        ...
        'phone_max' => 'Only 10 users can use this mobile number. Please try with another number',
        'phone_max_month' => 'An account with this mobile number is created recently. Please try after 30 days',
        'tag.required' => '해시태그를 완성해주세요'
    ],
    'user-2' => [
        'email.required' => 'The email is required.',
        'email.string' => 'The email is invalid.',
        'email.max' => 'The email is too long.',
        'email.unique' => '已存在的电子邮件 ID',
        'email.exists' => 'This email does not exist.',
        'social_id.required' => 'This social id is required.',
        'social_type.required' => 'This social type is required.',
        'password.required' => 'The password is required.',
        ...
        'phone_max' => 'Only 10 users can use this mobile number. Please try with another number',
        'phone_max_month' => 'An account with this mobile number is created recently. Please try after 30 days',
        'tag.required' => '请填写主题标签'
    ],
    'user-3' => [
        'email.required' => 'The email is required.',
        'email.string' => 'The email is invalid.',
        'email.max' => 'The email is too long.',
        'email.unique' => '既に存在している電子メールのIDを指定',
        'email.exists' => 'This email does not exist.',
        'social_id.required' => 'This social id is required.',
        'social_type.required' => 'This social type is required.',
        'password.required' => 'The password is required.',
    ...
    'request-form' => [
        ...
        'category_id.required_if' => 'The Category is required.',
    ...
    'request-form-1' => [
        'name.required' => 'The Name is required.',
        'user_id.required' => 'The User is required',
        'user_id.unique' => '이미 비즈니스 권한을 요청하였습니다.',
        'category_id.required' => 'The Category is required.',
        'category_id.required_if' => 'The Category is required.',
        'entity_type_id.required' => 'The Entity Type is required.',
        'entity_type_id.in' => 'The Entity Type is invalid.',
    ...
    'request-form-3' => [
        'name.required' => 'The Name is required.',
        'user_id.required' => 'The User is required',
        'user_id.unique' => 'すでにビジネス許可を要求しました.',
        'category_id.required' => 'The Category is required.',
        'category_id.required_if' => 'The Category is required.',
        'entity_type_id.required' => 'The Entity Type is required.',
        'entity_type_id.in' => 'The Entity Type is invalid.',
    ...
    'user-profile' => [
        ...
        'name.required' => 'The Username is required',
        'name.alpha' => 'Username is text only',
        'gender' => 'The gender is required',
    ...
    'category' => [
        ...
        'coins.required' => 'The coins is required',
        'currency_id.required' => 'The currency is required',
        'currency_id.exists' => 'The currency is required',
    ],
    'payment' => [
        'payment_method_nonce' => 'The payment method nonce is required',
        'amount' => 'The amount is required',
    ],
    'reload-coin' => [
        'currency_id' => 'The currency id is required',
    ],
    'comments' => [
        'comment' => 'The comment field is required',
        'community_id' => 'The community field is required.'
    ],
    'shopdetail' => [
        'shop_id.required' => 'The Shop ID field is required',
        'details.*.language_id.required' => 'The Language ID field is required',
        'details.*.value.required' => 'The value field is required',
    ]
];
