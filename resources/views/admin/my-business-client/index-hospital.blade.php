...
<script>
    ...
    var allHospitalTable = "{!! route('admin.my-business-client.all.hospital.table') !!}";
    var activeHospitalTable = "{!! route('admin.my-business-client.active.hospital.table') !!}";
    var inactiveHospitalTable = "{!! route('admin.my-business-client.inactive.hospital.table') !!}";
