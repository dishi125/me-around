...
class CreateCardStatusThumbnailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('card_status_thumbnails', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('character_thumb')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('card_status_thumbnails');
    }
}
