        ...
        <div class="col-12 col-md-12 col-lg-5">
            <div class="card profile-widget">
                ...
                <div class="profile-widget-description">
                    <div class="">
                        {!! Form::open(['route' => ['admin.important-setting.hospital.update',$id], 'id' =>"settingForm", 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            {!! Form::label('no_of_posts', __(Lang::get('forms.important-setting.no_of_posts'))); !!}
                                            {!! Form::text('no_of_posts', $no_of_posts, ['class' => 'form-control'. ( $errors->has('no_of_posts') ? ' is-invalid' : '' ), 'placeholder' => __(Lang::get('forms.important-setting.no_of_posts')) ]); !!}
                                            @error('no_of_posts')
                                            <div class="invalid-feedback">
                                                {{ $errors->first('no_of_posts') }}
                                            </div>
                                            @enderror
                                        </div>
                                    </div>
