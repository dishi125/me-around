...
<!--        <tr>
        ...
        @if($mailContent->instagram_account!=null)
        <tr>
            <th style="padding:15px;">Instagram Account Name</th>
            <td style="padding:15px;">{!! $mailContent->instagram_account !!}</td>
        </tr>
        @endif
        <tr>
        ...
        <tr>
            <th style="padding:15px;">Payment Time</th>
            <td style="padding:15px;">{!! $mailContent->payment_time !!}</td>
        </tr>
