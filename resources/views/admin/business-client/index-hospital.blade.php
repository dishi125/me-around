...
@role('Admin')
    <div class="section-header-button">
        <a href="javascript:void(0);" onclick="editAllBusinessCredits('hospital',`{{route('admin.give.all.user.credit')}}`);" class="btn btn-primary">Give coin to all Business User</a>
    </div> 
@endrole
@endsection
...
<script>
    ...
    var allHospitalTable = "{!! route('admin.business-client.all.hospital.table',[$manager_id]) !!}";
    var activeHospitalTable = "{!! route('admin.business-client.active.hospital.table',[$manager_id]) !!}";
    var inactiveHospitalTable = "{!! route('admin.business-client.inactive.hospital.table',[$manager_id]) !!}";
    var pendingHospitalTable = "{!! route('admin.business-client.pending.hospital.table',[$manager_id]) !!}";
...
<script src="{!! asset('js/pages/business-client/hospital.js') !!}"></script>
