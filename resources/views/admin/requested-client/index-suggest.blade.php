        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="confirm-btn">
                    ...
                    <a href="{!! route('admin.requested-client.confirmed.index',['type' => 'suggest']) !!}" class="btn btn-primary ml-5">Confirmed</a>
                </div>
...
@section('scripts')
<script>
var suggestIndex = "{!! route('admin.requested-client.all.suggest.table') !!}";
...
<script src="{!! asset('js/pages/requested-client/suggest.js') !!}"></script>
