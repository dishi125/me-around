        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-pills mb-4" id="myTab3" role="tablist">
                    ...
                    <li class="nav-item mr-3">
                        <a class="nav-link btn btn-success filterButton" id="active-data" data-filter="active" data-toggle="tab" href="#" role="tab" aria-controls="shop" aria-selected="false">Activate</a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link btn btn-secondary filterButton" id="inactive-data" data-filter="inactive" data-toggle="tab" href="#" role="tab" aria-controls="shop" aria-selected="false">Not Activate</a>
                    </li>
                </ul>
...
<script src="{!! asset('js/pages/business/shop/index.js') !!}"></script>
@endsection
