...
class PostManagementController extends Controller
{
    public function create(Request $request, $id){
        ...
        $selectedLanguage = [];
        return view('admin.business-client.posts.edit', compact('title','postLanguages', 'allCurrency', 'categorySelect','selectedLanguage','id'));
    }
    ...
    public function store(Request $request){
        ...
        try {
            ...
            return response()->json(["success" => true, "message" => "Post". trans("messages.insert-success"), "redirect" => route('admin.business-client.hospital.show',['id' => $inputs['hospital_id']])], 200);
        } catch (\Exception $e) {
            Log::info($e);
            DB::rollBack();
            return response()->json(["success" => false, "message" => "Post". trans("messages.insert-error"), "redirect" => route('admin.business-client.hospital.show',['id' => $inputs['hospital_id']])], 200);
        }
    ...
    public function edit(Request $request, $id){
        ...
        return view('admin.business-client.posts.edit', compact('title','post', 'imagesArray', 'postLanguages', 'allCurrency', 'categorySelect','selectedLanguage'));
    }
        ...
        try {
            ...
            if($user){
                ...
                if($post){
                   ...
                   return response()->json(["success" => true, "message" => "Post". trans("messages.update-success"), "redirect" => route('admin.business-client.hospital.show',['id' => $hospital_id])], 200);

                }else{                    
                    return response()->json(["success" => false, "message" => "Post". trans("messages.update-error"), "redirect" => route('admin.business-client.hospital.show',['id' => $hospital_id])], 200);
                }
            }else{
                return response()->json(["success" => false, "message" => "Post". trans("messages.update-error"), "redirect" => route('admin.business-client.hospital.show',['id' => $hospital_id])], 200);
            }   
