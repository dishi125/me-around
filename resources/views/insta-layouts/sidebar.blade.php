...
<!--    <div class="sidebar-brand">
    ...
    <ul class="sidebar-menu mb-3">
        ...
        <li class="{{ Request::segment(2) == 'dashboard' ? 'active' : '' }}">
            <a href="{{ route('insta.dashboard.index') }}" class="nav-link"><i class="fas fa-home"></i>
                <span>Dashboard</span>
            </a>
        </li>
        <li class="{{ Request::segment(2) == 'important-setting' ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('insta.important-setting.index') }}"><i class="fas fa-chalkboard-teacher"></i>
                <span>{{ __('menu.important_settings') }}</span>
            </a>
        </li>
        <li class="{{ Request::segment(2) == 'users' ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('insta.user.index') }}"><i class="fas fa-users"></i>
