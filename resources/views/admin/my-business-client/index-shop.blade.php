...
<script>
    ...
    var allShopTable = "{!! route('admin.my-business-client.all.shop.table') !!}";
    var activeShopTable = "{!! route('admin.my-business-client.active.shop.table') !!}";
    var inactiveShopTable = "{!! route('admin.my-business-client.inactive.shop.table') !!}";
