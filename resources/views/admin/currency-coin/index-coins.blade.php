...
<div class="section-header-button">
    <?php $user = Auth::user();?>
    <a href="{{ route('admin.currency-coin.create') }}" class="btn btn-primary">Add New</a>
</div>
@endsection
...
<script>
        ...
        var currencyCategory = "{{ route('admin.currency.coin.table') }}";
        var csrfToken = "{{csrf_token()}}";    
</script>
<script src="{!! asset('plugins/datatables/datatables.min.js') !!}"></script>
<script src="{!! asset('js/pages/currency-coin/index-coins.js') !!}"></script>
@endsection