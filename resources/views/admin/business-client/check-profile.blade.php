            ...
            <div class="row align-items-xl-center mb-3">
                ...
                <table>
                    ...
                    @foreach($hospitals as $hospital)
                        <tr>
                            <td><a role='button' href="{{route('admin.business-client.hospital.show', $hospital->id)}}" title='' data-original-title='View' class='btn btn-primary btn-lg mr-3' data-toggle='tooltip'>See Profile</a></td>
