        ...
        <div class="card">
            <div class="card-body">
                  <div class="activity-tabs">
					  ...
					  @endforeach
					  @foreach($hospitalCategories as $sc)
					  <input type='radio' id='cat_{{$sc->id}}' name='t'><label class="activity-label" for='cat_{{$sc->id}}'>{{$sc->name}}</label>
					  <div class='content'>
					  	<ul class="nav nav-pills mb-4" id="myTab3" role="tablist">
							<li class="nav-item mr-2">
					  ...
					  @endforeach
					  @foreach($customCategories as $sc)
					  <input type='radio' id='cat_{{$sc->id}}' name='t'><label class="activity-label" for='cat_{{$sc->id}}'>{{$sc->name}}</label>
					  <div class='content'>
					  	<ul class="nav nav-pills mb-4" id="myTab3" role="tablist">
							<li class="nav-item mr-2">
...
<script>
	var shopCategories = <?php echo json_encode($shopCategories) ?>;
	var hospitalCategories = <?php echo json_encode($hospitalCategories) ?>;
	var customCategories = <?php echo json_encode($customCategories) ?>;	

    $(function() {
		$.each(shopCategories, function (i, elem) {
		...
		$.each(hospitalCategories, function (i, elem) {
			$("#all-table-"+ elem.id).DataTable();			
			$("#inquire-table-"+ elem.id).DataTable();
			$("#book-table-"+ elem.id).DataTable();
			$("#visited-table-"+ elem.id).DataTable();
		...
		$.each(customCategories, function (i, elem) {
			$("#all-table-"+ elem.id).DataTable();			
			$("#inquire-table-"+ elem.id).DataTable();
			$("#book-table-"+ elem.id).DataTable();
			$("#visited-table-"+ elem.id).DataTable();
